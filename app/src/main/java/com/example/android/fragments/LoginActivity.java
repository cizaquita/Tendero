...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            Botón de registro para nuevos tenderos
         */
        Button btnRegisterView = (Button) findViewById(R.id.btn_register);
         ...
         *
         */
        btnRegisterView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            String url = "http://api.tiendosqui.com/login/";
